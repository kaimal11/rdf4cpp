...
template<>
inline xsd::DateTimeStamp RegisteredDatatype<xsd::DateTimeStamp, xsd_dateTimeStamp>::from_string(const std::string &s) {
    ...
    if (std::regex_match(s, dateTimeStamp_regex)) {
