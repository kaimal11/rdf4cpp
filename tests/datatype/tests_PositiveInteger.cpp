...
TEST_CASE("Datatype PositiveInteger") {
    ...
    auto iri = rdf4cpp::rdf::IRI(RegisteredDatatype<xsd::PositiveInteger, xsd_positiveInteger>::datatype_iri());

    auto iri_str = rdf4cpp::rdf::IRI("http://www.w3.org/2001/XMLSchema#positiveInteger");
