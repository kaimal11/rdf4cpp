...
TEST_CASE("Datatype NegativeInteger") {
    ...
    value = -1;
    auto lit4 = rdf4cpp::rdf::Literal{std::to_string(value), "http://www.w3.org/2001/XMLSchema#negativeinteger"};
    CHECK(lit4.value<xsd::NegativeInteger, xsd_negativeInteger>() == value);

    value = -18446744073709;
    auto lit5 = rdf4cpp::rdf::Literal{std::to_string(value), "http://www.w3.org/2001/XMLSchema#negativeinteger"};
