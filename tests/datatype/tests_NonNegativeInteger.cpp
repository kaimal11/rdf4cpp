...
TEST_CASE("Datatype NonNegativeInteger") {
    ...
    value = 1;
    auto lit4 = rdf4cpp::rdf::Literal{std::to_string(value), "http://www.w3.org/2001/XMLSchema#nonnegativeinteger"};
    CHECK(lit4.value<xsd::NonNegativeInteger, xsd_nonNegativeInteger>() == value);

    value = 18446744073709;
    auto lit5 = rdf4cpp::rdf::Literal{std::to_string(value), "http://www.w3.org/2001/XMLSchema#nonnegativeinteger"};
