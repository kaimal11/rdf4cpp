...
TEST_CASE("Datatype NonNegativeInteger") {
    ...
    auto iri = rdf4cpp::rdf::IRI(RegisteredDatatype<xsd::NonNegativeInteger, xsd_nonNegativeInteger>::datatype_iri());

    auto iri_str = rdf4cpp::rdf::IRI("http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
