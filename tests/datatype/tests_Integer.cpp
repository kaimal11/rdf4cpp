...
TEST_CASE("Datatype Integer") {
    ...
    value = 1;
    auto lit4 = rdf4cpp::rdf::Literal{std::to_string(value), "http://www.w3.org/2001/XMLSchema#integer"};
    CHECK(lit4.value<xsd::Integer, xsd_integer>() == value);

    value = 2147483647;
    auto lit5 = rdf4cpp::rdf::Literal{std::to_string(value), "http://www.w3.org/2001/XMLSchema#integer"};
