...
TEST_CASE("Datatype DateTime") {
    ...
    constexpr auto correct_type_iri_cstr = "http://www.w3.org/2001/XMLSchema#dateTime";

    CHECK(std::string(datatypes::xsd::DateTime::identifier) == correct_type_iri_cstr);

    auto type_iri = IRI(datatypes::xsd::DateTime::identifier);
    CHECK(type_iri.identifier() == correct_type_iri_cstr);

    using type = datatypes::xsd::DateTime::cpp_type;
    ...
    auto lit1 = Literal::make<datatypes::xsd::DateTime>(value);
    CHECK(lit1.value<datatypes::xsd::DateTime>() == value);
    ...
    auto lit2 = Literal::make<datatypes::xsd::DateTime>(value);
    CHECK(lit2.value<datatypes::xsd::DateTime>() == value);
    ...
    auto lit3 = Literal::make<datatypes::xsd::DateTime>(value);
    CHECK(lit3.value<datatypes::xsd::DateTime>() == value);
