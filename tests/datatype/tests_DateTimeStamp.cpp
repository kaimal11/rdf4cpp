...
TEST_CASE("Datatype DateTimeStamp") {
    ...
    auto lit1 = rdf4cpp::rdf::Literal::make<xsd::DateTimeStamp, xsd_dateTimeStamp>(value);
    CHECK(lit1.value<xsd::DateTimeStamp, xsd_dateTimeStamp>() == value);
    ...
    auto lit2 = rdf4cpp::rdf::Literal::make<xsd::DateTimeStamp, xsd_dateTimeStamp>(value);
    CHECK(lit2.value<xsd::DateTimeStamp, xsd_dateTimeStamp>() == value);
    ...
    auto lit3 = rdf4cpp::rdf::Literal::make<xsd::DateTimeStamp, xsd_dateTimeStamp>(value);
    CHECK(lit3.value<xsd::DateTimeStamp, xsd_dateTimeStamp>() == value);
    std::cout<<lit1;
